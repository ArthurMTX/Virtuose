...
program
    .option('-m, --with-source-maps [type]', 'output source maps when not generating a bundled frontend (type may be empty for external source maps, inline for inline source maps, or both) ')
